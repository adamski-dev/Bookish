...
export class CheckoutPaymentComponent implements OnInit{
  ...
  ngOnInit(): void {
    loadStripe("pk_test_51MjlxvKcASG1gBdpaf6feOU1C8Xc9XzDxGjiVd6NKtCXJnIiw81pnfRq9xpiiFNOeUnNs0lG3MilhPBv07gISEz900TxMELGrd")
      .then(stripe =>{
        this.stripe = stripe;
  ...
  async submitOrder(){
    ...
    if(!basket) throw new Error('Unable to get basket');
    try {
